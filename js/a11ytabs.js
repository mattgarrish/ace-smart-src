...
var a11y_tabs_license = 'jQuery Accessible tab panel system, using ARIA -- Website: http://a11y.nicolas-hoffmann.net/tabs/ -- License MIT: https://github.com/nico3333fr/jquery-accessible-tabs-aria/blob/master/LICENSE';
 ...
 */
		...
		$( "body" ).on( "click", ".js-tablist__link:not([aria-disabled='true'])", function( event ) {
				var $this = $( this ),
					...
					$parent_item = $this.closest( ".js-tablist__item" ),
					$all_tab_items = $parent.find( ".js-tablist__item" );
 
				// set active border
				$all_tab_items.attr({ 
					"class": "js-tablist__item tabs__item"
					});
					
				$parent_item.attr({
					"class": "js-tablist__item tabs__item active"
					});
