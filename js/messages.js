...
var smart_errors = new Object();
	...
	smart_errors.en.noreloadid = 'Saved evaluation does not contain an identifier. Please reload from your evaluation history.';
	...
	smart_errors.en.idprep = 'An error occurred checking the evaluation id. Please try again.';
	smart_errors.en.idbind = 'An error occurred verifying the evaluation id. Please try again.';
	smart_errors.en.idexec = 'An error occurred retrieving the evauation id. Please try again.';
	smart_errors.en.noid = 'The evaluation identifier does not match any evaluations for your account. The file could not be loaded.';
