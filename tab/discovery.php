...
<section id="discovery" class="js-tabcontent">
	...
	<fieldset id="accessibilityFeature">
		...
		<div id="add-feature" class="link"><a href="#add-feature" id="add-a11y-feature">Add custom field</a></div>
	</fieldset>
	
	<fieldset id="summary-field">
		<legend><label for="accessibilitySummary"><a href="http://www.idpf.org/epub/a11y/techniques/#meta-005" target="_blank">Accessibility Summary</a> <img src="/images/asterisk.png" alt="required"/></label></legend>
		<textarea id="accessibilitySummary" rows="5" aria-required="true"></textarea>
	</fieldset>
	
	<fieldset id="accessibilityHazard">
		<legend><a href="http://www.idpf.org/epub/a11y/techniques/#meta-004" target="_blank">Accessibility Hazards</a> <img src="/images/asterisk.png" alt="required"/></legend>
		<div class="cols">
	...
	<fieldset id="accessMode">
		<legend><a href="http://www.idpf.org/epub/a11y/techniques/#meta-001" target="_blank">Access Modes</a> <img src="/images/asterisk.png" alt="required"/></legend>
		<div class="cols">
	...
	<fieldset id="accessModeSufficient">
		...
		<div id="add-ams" class="link"><a href="#add-ams" id="add-sufficient">Add another set</a></div>
	</fieldset>
	...
	<div class="buttons">
		<input type="button" id="discovery_button" value="Generate"/>
	</div>
