...
<?php } ?>
                ...
                <div id="agreement">
                	<?php require $abs_us_root.$us_url_root.'usersc/includes/user_agreement.php'; ?>
                </div>
        ...
        <button class="submit btn btn-primary " type="submit" id="next_button"><i class="fa fa-plus-square"></i> Create Account</button>
</form><br />
</div>
</div>
