...
<html lang="en" prefix="dcterms: http://purl.org/dc/terms/ schema: http://schema.org/" typeof="schema:WebPage">
	<head>
		...
		<?php echo "<script>var smart_extensions = {}; var ACE_USER = '" . $user->data()->username . "'; var ACE_SHARED = " . $user->data()->shared . "; var ACE_USER_CO = '" . $user->data()->company . "'; var ACE_ACTION = '" . $_POST['action'] . "'; var ACE_ID = '" . $eval->get_eval_id() . "'; var saveChanges = false; var firstSave = " . $eval->need_to_save() . ";</script>"; ?>
